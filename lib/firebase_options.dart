...
class DefaultFirebaseOptions {
  static FirebaseOptions get currentPlatform {
    ...
    // Note: You'll need to add your mobile configurations here if you
    // are not using the FlutterFire CLI. For now, this will throw an error
    // on mobile to remind you.
  ...
  // 🔹 PASTE YOUR WEB CONFIGURATION KEYS HERE 🔹
